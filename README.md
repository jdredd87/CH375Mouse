...
| **[CH375Net](CH375Net/)** | **it pings.** USB Ethernet through an ASIX AX88179, with a Crynwr packet driver at INT 65h. `mTCP` runs over it: 3 of 3 ICMP replies from the router, on an 8086 |
