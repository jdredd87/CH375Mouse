...
| **[CH375Net](CH375Net/)** | **it reaches the internet.** USB Ethernet through an ASIX AX88179, with a Crynwr packet driver at INT 65h. `mTCP` runs over it and an 8086 pings 8.8.8.8, ttl=118 |
